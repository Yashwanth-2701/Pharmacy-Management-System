...
<h2 style="font-style:bold; font-size:30px;padding-left:30px;">View Pharmacist</h2>
...
<?php
	...
	echo"</table>";
            ...
            if(mysqli_num_rows($ret)==0)
            {
                      echo "<div id='card'><h1>No Pharmacist are thier to view....</h1><form action='admin_home.php'><button type='submit' id='done'>Done</button></form></div>";
